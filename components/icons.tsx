...
export const SparklesIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m1-12l1.414-1.414M18.586 5.414L20 4m-1.414 14.172L17 20m2.586-1.414l-1.414-1.414M4 20l1.414-1.414M18.586 18.586L20 20M4 4l1.414 1.414M18.586 4L20 5.414" />
  </svg>
);
...
export const PosterIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mb-4 text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 3h16a1 1 0 011 1v16a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1zm4 8l3-3 3 3m-3-3v8" />
    </svg>
);
